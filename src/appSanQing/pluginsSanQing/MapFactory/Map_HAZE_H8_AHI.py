...
class Map_HAZE_H8_AHI(BaseProcess):
    """AOD_H8_AHI绘图"""
    ...
    def AddIssue(self, fig, Issue, issueLabelText):
        ...
        try:
            ...
            print("期次添加失败")
            return
    def AddColorBar(self, fig, ax, data, colorlevels, colors, colorlabels, nrow=2, labelmark=False, pos=None):
        """
        ...
        try:
            ...
            if pos is None:
                ...
                pos = [box.xmin + 0.01, 0.035, 0.2, 0.025]
    ...
    def AddGradinetColorBar(self, fig, ax, im_handle, colorlabels, nrow=1, labelmark=False, pos=None, id=None):
        try:
            ...
            if pos is None:
                pos = [box.xmin+ 0.01, 0.035, 0.150, 0.025]
            ...
            minV = round(im_handle.norm.vmin + 0.01, 2)
            maxV = round(im_handle.norm.vmax - 0.01, 2)
            if labelmark:
